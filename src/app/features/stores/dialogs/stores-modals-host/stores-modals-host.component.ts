...
@Component({
  ...
  template: `
    @switch (ui.activeModal()?.id) {
      @case ('store-create') {
        @defer (on immediate) {
          <app-modal title="Nueva tienda" size="md" [isOpen]="true" [dismissible]="false" (closed)="ui.closeModal()">
      ...
      @case ('store-edit') {
        @defer (on immediate) {
          <app-modal title="Editar tienda" size="md" [isOpen]="true" [dismissible]="false" (closed)="ui.closeModal()">
      ...
      @case ('store-delete') {
        @defer (on immediate) {
          <app-modal title="Eliminar tienda" size="sm" [isOpen]="true" [dismissible]="false" (closed)="ui.closeModal()">
